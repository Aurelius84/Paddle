...
class SearchAttentionPaddingMaskGradOpMaker
 ...
 protected:
  std::unique_ptr<T> Apply() const override {
    ...
    op_desc_ptr->SetInput("Y", this->Input("Y"));
    op_desc_ptr->SetInput("pad_begin", this->Output("pad_begin"));
...
REGISTER_OPERATOR(
    search_attention_padding_mask, ops::SearchAttentionPaddingMaskOP,
    ops::SearchAttentionPaddingMaskOpMaker,
    ops::SearchAttentionPaddingMaskGradOpMaker<paddle::framework::OpDesc>,
    ops::SearchAttentionPaddingMaskGradOpMaker<paddle::imperative::OpBase>);
